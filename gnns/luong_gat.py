...
class LuongGATConv(GATConv):
    ...
    def __init__(self, in_channels: Union[int, Tuple[int, int]],
        ...
        super(LuongGATConv, self).__init__(in_channels=(in_channels, in_channels), out_channels=out_channels,
    ...
    def message(self, x_j: Tensor, alpha_j: Tensor, alpha_i: OptTensor,
        ...
        alpha = (alpha_i * alpha_j).sum(-1)  # (edges, H)
